...
local respawnButton = CreateButton(contentFrame, "Btn_Respawn", "Instant Respawn", UDim2.new(0,0,0,0))
...
respawnButton.MouseButton1Click:Connect(function()
    ...
    if instantRespawnEnabled then
        ...
        respawnButton.Text = "Instant Respawn: ON"
    else
        DisableInstantRespawn()
        respawnButton.Text = "Instant Respawn"
    end
end)
