...
local gravityInput = CreateTextInput(contentFrame, "Gravity (196 default)", UDim2.new(0, 20, 0, 270))
local setGravityButton = CreateButton(contentFrame, "SetGravity", "Set Gravity", UDim2.new(0, 190, 0, 270))
---------------------------------------------------------------------
-- WALK SPEED
---------------------------------------------------------------------
