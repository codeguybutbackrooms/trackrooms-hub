...
--// Create the collapsible player list with scrollable content
local playerListContent = CreateCollapsible(contentFrame, "Players", true)

-- Create a ScrollingFrame inside collapsible content
local scrollFrame = Instance.new("ScrollingFrame")
scrollFrame.Size = UDim2.new(1,0,1,0)
scrollFrame.BackgroundTransparency = 1
scrollFrame.ScrollBarThickness = 6
scrollFrame.Parent = playerListContent
...
listLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    scrollFrame.CanvasSize = UDim2.new(0,0,listLayout.AbsoluteContentSize.Y + 5,0)
end)
