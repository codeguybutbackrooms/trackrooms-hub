...
-- COLLAPSIBLE
---------------------------------------------------------------------
function CreateCollapsible(parent, titleText)
    ...
    header.MouseButton1Click:Connect(function()
        opened = not opened
        header.Text = (opened and "▲ " or "▼ ") .. titleText

        local targetSize = opened and listLayout.AbsoluteContentSize.Y or 0
        listFrame:TweenSize(
            UDim2.new(1, 0, 0, targetSize),
            "Out", "Quad", 0.25, true
        )
    end)
...
playersLabel.TextColor3 = Color3.fromRGB(0,170,255)
playersLabel.Font = Enum.Font.GothamBold
playersLabel.TextScaled = true
playersLabel.TextXAlignment = "Left"
local playersListFrame = Instance.new("Frame")
playersListFrame.Parent = contentFrame
playersListFrame.BackgroundTransparency = 1
playersListFrame.Size = UDim2.new(1, -10, 0, 10)
local plistLayout = Instance.new("UIListLayout", playersListFrame)
...
function AddPlayerRow(parent, player)
    ...
    userLabel.Position = UDim2.new(0, 50, 0, 25)
