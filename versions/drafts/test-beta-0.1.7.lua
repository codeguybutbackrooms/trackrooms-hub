...
local fovInput = CreateTextInput(mainUIFrame, "Enter FOV", UDim2.new(0, 20, 0, 220))
local setFOVButton = CreateButton(mainUIFrame, "SetFOV", "Set FOV", UDim2.new(0, 190, 0, 220))
local gravityInput = CreateTextInput(mainUIFrame, "Gravity (196 default)", UDim2.new(0, 20, 0, 270))
local setGravityButton = CreateButton(mainUIFrame, "SetGravity", "Set Gravity", UDim2.new(0, 190, 0, 270))
---------------------------------------------------------------------
-- WALK SPEED
---------------------------------------------------------------------
...
-- GRAVITY CHANGER
---------------------------------------------------------------------
setGravityButton.MouseButton1Click:Connect(function()
    local n = tonumber(gravityInput.Text)
    if n then
        workspace.Gravity = n
    else
        gravityInput.Text = ""
        gravityInput.PlaceholderText = "Invalid number!"
    end
end)
